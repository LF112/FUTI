 /*
 * 请注意，此 Live2D Framework 非官方原版，已为适配 Vite 载入而更改部分代码。
	...
	var Animation = (function() {
		...
		Animation.prototype.evaluate = function(
			...
			this.parameterTracks.forEach(function(t) {
				if (
					t.targetId == 'PARAM_ANGLE_X' ||
					t.targetId == 'PARAM_ANGLE_Y' ||
					t.targetId == 'PARAM_EYE_BALL_X' ||
					t.targetId == 'PARAM_EYE_BALL_Y' ||
					t.targetId == 'ParamAngleX' ||
					t.targetId == 'ParamAngleY' ||
					t.targetId == 'ParamEyeBallX' ||
					t.targetId == 'ParamEyeBallY'
				) {
					return
				}
